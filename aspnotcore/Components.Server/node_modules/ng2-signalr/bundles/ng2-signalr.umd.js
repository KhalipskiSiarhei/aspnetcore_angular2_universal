...
var SignalR = (function () {
    ...
    SignalR.prototype.connect = function (options) {
        ...
        var /** @type {?} */ $promise = new Promise(function (resolve, reject) {
            ...
            var /** @type {?} */ jTransports = _this.convertTransports(configuration.transport);
            try {
                var /** @type {?} */ serializedQs = JSON.stringify(configuration.qs);
                var /** @type {?} */ serializedTransport = JSON.stringify(jTransports);
     ...
     * @return {?}
     */
    SignalR.prototype.convertTransports = function (transports) {
